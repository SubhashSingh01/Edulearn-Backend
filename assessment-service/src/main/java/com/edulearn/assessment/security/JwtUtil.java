...
public class JwtUtil {
    ...
    public boolean validateToken(String t) {
        try { claims(t); return true; } catch (JwtException | IllegalArgumentException e) { log.warn("JWT: {}", e.getMessage()); return false; }
    }
    ...
    public Long   extractUserId(String t) { Object id = claims(t).get("userId"); if (id instanceof Integer i) return i.longValue(); return (Long) id; }
